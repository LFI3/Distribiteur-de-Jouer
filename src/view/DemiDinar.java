...
public class DemiDinar extends Fenetre implements Runnable {

    public DemiDinar() 
    {

        plan = new javax.swing.JPanel();
        demidinar1 = new javax.swing.JButton();
        ...
        add(plan);
        //----------------------------------------------------------------------
        demidinar1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/500_millimes.jpg"))); // NOI18N
        demidinar1.setBorder(javax.swing.BorderFactory.createMatteBorder(7, 7, 7, 7, new javax.swing.ImageIcon(getClass().getResource("/image/cadre5.jpg")))); // NOI18N
        demidinar1.setBounds(240, 110, 610, 300);
        //----------------------------------------------------------------------
    ...
    private javax.swing.JButton demidinar1;
